...
class SidewalkCleanMetaUrbanEnv(BaseEnv):
    @classmethod
    def default_config(cls) -> Config:
        config = super(SidewalkCleanMetaUrbanEnv, cls).default_config()
    ...
    def __init__(self, config: Union[dict, None] = None):
        ...
        super(SidewalkCleanMetaUrbanEnv, self).__init__(config)
    ...
    def _post_process_config(self, config):
        config = super(SidewalkCleanMetaUrbanEnv, self)._post_process_config(config)
    ...
    def setup_engine(self):
        super(SidewalkCleanMetaUrbanEnv, self).setup_engine()
